...
**Status:** ✅ **DONE** — basic STA/SCAN/AP released (Days 28–33). All P0/P1 samples shipped.
See `docs/qemu-wifi-stock-samples.md` and `tools/run-basic-wifi-smoke.sh` for the release gate.
...
| `examples/protocols/sockets/udp_client/` | Done | Done: `Echo (UDP): Hello from ESP32` | P1 sample — Day 33 |
...
**Status:** ✅ **DONE** (Day 27 tcp_client; Day 33 udp_client + lwip_probe). Linux.
